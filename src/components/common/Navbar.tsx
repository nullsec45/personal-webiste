  ...
  return (
    ...
    >
      <div className="flex py-4 items-center justify-between mx-auto max-w-5xl  px-5">
        ...
        <div className="w-full max-w-md ms-auto font-medium space-x-12 hidden md:flex justify-end items-center">
          <NavItem />
        </div>
        ...
        <div className="flex">
          <Sheet>
            ...
            <SheetContent side={'top'} className="md:hidden block h-full">
