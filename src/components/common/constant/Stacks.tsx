...
export const Stacks = [
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="h-8 w-8 rounded-sm text-white">
  ...
  {
    icon: <img src="/vite.svg" alt="vite.png" width={50} height={50} loading="lazy" />,
    label: 'Vite',
  },
  ...
  {
    icon: <img src="/img/zustand.png" alt="zustand.png" width={50} height={50} loading="lazy" />,
    label: 'Zustand',
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 256 331">
        <defs>
